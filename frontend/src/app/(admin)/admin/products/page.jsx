            ...
            <div className="max-w-screen-xl mx-auto p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-5">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                    <div>
                        ...
                        <p className="text-sm sm:text-lg text-gray-500 mt-0.5 hidden sm:block">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                        <button
                            onClick={fetchData}
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 text-sm sm:text-lg font-medium bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
                        >
                        ...
                        <Link
                            ...
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 text-sm sm:text-lg font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm flex-1 sm:flex-none justify-center sm:justify-start"
                        >
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-3 sm:p-4 space-y-3">
                    <div className="flex flex-col gap-2 sm:gap-3">
                        ...
                        <div className="relative w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2.5 text-sm sm:text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                            />
                            {keyword && (
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-3">
                            <select
                                ...
                                className="px-3 py-2.5 text-sm sm:text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white"
                            >
                            ...
                            <select
                                ...
                                className="px-3 py-2.5 text-sm sm:text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white col-span-2 sm:col-span-1 sm:w-32"
                            >
                    ...
                    {hasActiveFilter && (
                        <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-gray-100">
                            ...
                            <span className="text-xs sm:text-md text-gray-500">Đang lọc:</span>
                            ...
                            <button onClick={clearFilters} className="ml-auto text-xs sm:text-md font-medium text-red-500 hover:text-red-700 flex items-center gap-1">
...
const SummaryCard = ({ icon, label, value, bg }) => (
    <div className={`${bg} rounded-xl sm:rounded-2xl p-2.5 sm:p-4 flex items-center gap-2 sm:gap-4 border border-white shadow-sm`}>
        ...
        <div className="min-w-0">
            <p className="text-xs sm:text-md font-medium text-gray-600 mb-0.5 truncate">{label}</p>
            <p className="font-bold text-gray-900 text-lg sm:text-2xl leading-none">{value}</p>
        </div>
    </div>
);
