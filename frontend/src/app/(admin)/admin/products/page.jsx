            ...
            <div className="max-w-screen-xl mx-auto p-4 md:p-6 space-y-5">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={fetchData}
                            className="flex items-center gap-2 px-4 py-2 text-lg font-medium bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
                        >
                        ...
                        <Link
                            ...
                            className="flex items-center gap-2 px-4 py-2 text-lg font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    />
                    <SummaryCard
                        icon={<Tag size={22} className="text-green-500" />}
                        label="Thương hiệu"
                        value={brands.length}
                        bg="bg-green-50"
                    />
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 space-y-3">
                    <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="Tìm theo tên sản phẩm (Hỗ trợ tìm kiếm mờ)..."
                                value={keyword}
                                onChange={e => setKeyword(e.target.value)}
                                className="w-full pl-9 pr-4 py-2.5 text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                            />
                            {keyword && (
                        ...
                        <select
                            ...
                            className="px-3 py-2.5 text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white min-w-[180px]"
                        >
                        ...
                        <select
                            ...
                            className="px-3 py-2.5 text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white w-32"
                        >
                    ...
                    {hasActiveFilter && (
                        <div className="flex flex-wrap items-center gap-2 pt-1 border-t border-gray-100">
                            ...
                            <button onClick={clearFilters} className="ml-auto text-md font-medium text-red-500 hover:text-red-700 flex items-center gap-1">
                                    ...
                                    <tr>
                                        <td colSpan={8} className="py-16 text-center">
                                            <div className="flex flex-col items-center gap-3 text-gray-400">
                                                ...
                                                <span className="text-lg">Không tìm thấy sản phẩm nào</span>
                                                {hasActiveFilter && (
...
const SummaryCard = ({ icon, label, value, bg }) => (
    <div className={`${bg} rounded-2xl p-4 flex items-center gap-4 border border-white shadow-sm`}>
        <div className="shrink-0 p-3 bg-white/60 rounded-xl">{icon}</div>
        <div className="min-w-0">
            <p className="text-md font-medium text-gray-600 mb-0.5 truncate">{label}</p>
...
const PaginationBtn = ({ onClick, disabled, active, label }) => (
    <button
        onClick={onClick}
        disabled={disabled}
        className={`min-w-[34px] h-[34px] px-2 flex items-center justify-center rounded-lg text-lg font-medium transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed ${active
