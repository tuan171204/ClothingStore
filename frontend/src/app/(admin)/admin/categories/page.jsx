...
export default function CategoriesPage() {
    ...
    const parentOnly = levelFilter === 'root';
    const childOnly = levelFilter === 'child';
                ...
                <div className="flex items-center gap-2">
                    ...
                    {[
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all cursor-pointer border
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                {loading ? (
                    ...
                    <div className="py-16 text-center text-gray-400">
                        ...
                        <p>{keyword ? `Không tìm thấy "${keyword}"` : 'Chưa có danh mục nào'}</p>
                    </div>
                ) : (
                    <>
